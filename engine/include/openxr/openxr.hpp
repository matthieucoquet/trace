...
#define OPENXR_HPP_DEFAULT_DISPATCHER                                          \
  ::OPENXR_HPP_NAMESPACE::defaultDispatchLoaderDynamic
#define OPENXR_HPP_DEFAULT_DISPATCH_LOADER_DYNAMIC_STORAGE                     \
  namespace OPENXR_HPP_NAMESPACE {                                             \
...
#else
#define OPENXR_HPP_DEFAULT_DISPATCHER                                          \
  ::OPENXR_HPP_NAMESPACE::DispatchLoaderStatic()
#endif
#endif
...
public:
   ...
   */
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result getInstanceProcAddr(const char *name, PFN_xrVoidFunction *function,
                             Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
   ...
   */
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result destroy(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  ResultValueType<void>::type
  destroy(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result
  getInstanceProperties(InstanceProperties &instanceProperties,
                        Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  getInstanceProperties(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  getSystem(const SystemGetInfo &getInfo,
            Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Allocator = std::allocator<EnvironmentBlendMode>,
            typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  ...
  stringToPath(const char *pathString,
               Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  Result convertTimeToWin32PerformanceCounterKHR(
      const Time &time, LARGE_INTEGER *performanceCounter,
      Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  convertTimeToWin32PerformanceCounterKHR(
      const Time &time, Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  Result convertTimespecTimeToTimeKHR(
      const struct timespec *timespecTime, const Time &time,
      Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  Result convertTimeToTimespecTimeKHR(
      const Time &time, struct timespec *timespecTime,
      Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
...
public:
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result
  enumerateReferenceSpaces(uint32_t spaceCapacityInput,
                           uint32_t *spaceCountOutput,
  ...
  enumerateReferenceSpaces(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Allocator = std::allocator<ReferenceSpaceType>,
            typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  typename ResultValueType<std::vector<ReferenceSpaceType, Allocator>>::type
  enumerateReferenceSpaces(Allocator const &vectorAllocator, Dispatch d) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result
  getReferenceSpaceBoundsRect(ReferenceSpaceType referenceSpaceType,
                              Extent2Df &bounds,
                              Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result
  enumerateSwapchainFormats(uint32_t formatCapacityInput,
  ...
  enumerateSwapchainFormats(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Allocator = std::allocator<int64_t>,
            typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  typename ResultValueType<std::vector<int64_t, Allocator>>::type
  enumerateSwapchainFormats(Allocator const &vectorAllocator, Dispatch d) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  ResultValueType<void>::type
  beginSession(const SessionBeginInfo &beginInfo,
               Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
   ...
   */
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result endSession(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  ResultValueType<void>::type
  endSession(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
   ...
   */
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result requestExitSession(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  ResultValueType<void>::type
  requestExitSession(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  ResultValueType<void>::type
  endFrame(const FrameEndInfo &frameEndInfo,
           Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  Result enumerateBoundSourcesForAction(
      ...
      uint32_t sourceCapacityInput, uint32_t *sourceCountOutput,
      const Path &sources, Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  Result setAndroidApplicationThreadKHR(
      AndroidThreadTypeKHR threadType, uint32_t threadId,
      Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  typename ResultValueType<jobject>::type createSwapchainAndroidSurfaceKHR(
      const SwapchainCreateInfo &info, Swapchain &swapchain,
      Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  createSwapchainAndroidSurfaceUniqueKHR(
      const SwapchainCreateInfo &info, Swapchain &swapchain,
      Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
#endif /*OPENXR_HPP_NO_SMART_HANDLE*/
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
   ...
   */
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  typename ResultValueType<VisibilityMaskKHR>::type
  ...
  Result thermalGetTemperatureTrendEXT(
      ...
      float *tempSlope, Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  Result setInputDeviceLocationEXT(
      ...
      XrPosef pose, Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
...
public:
  ...
  template <typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  Result
  enumerateSwapchainImages(uint32_t imageCapacityInput,
                           uint32_t *imageCountOutput,
  ...
  enumerateSwapchainImages(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER) const;
  ...
  template <typename ResultItemType,
            ...
            typename Dispatch = decltype((OPENXR_HPP_DEFAULT_DISPATCHER))>
  typename ResultValueType<std::vector<ResultItemType, Allocator>>::type
  enumerateSwapchainImages(Allocator const &vectorAllocator, Dispatch d) const;
...
Result enumerateApiLayerProperties(uint32_t propertyCapacityInput,
                                   ...
                                   Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER);
...
enumerateApiLayerProperties(Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER);
...
enumerateInstanceExtensionProperties(
    const char *layerName, Dispatch d = OPENXR_HPP_DEFAULT_DISPATCHER);
...
struct ApiLayerProperties {
  ...
  StructureType type = StructureType::ApiLayerProperties;
...
struct ExtensionProperties {
  ...
  StructureType type = StructureType::ExtensionProperties;
  void *XR_MAY_ALIAS next = nullptr;
...
struct ApplicationInfo {
  ...
  ApplicationInfo(const char *applicationName_ = nullptr,
                  ...
                  uint32_t engineVersion_ = {}, const Version &apiVersion_ = {})
...
struct InstanceCreateInfo {
  ...
  InstanceCreateInfo(const InstanceCreateFlags &createFlags_ = {},
                     ...
                     uint32_t enabledApiLayerCount_ = {},
  ...
  StructureType type = StructureType::InstanceCreateInfo;
...
struct InstanceProperties {
  ...
  StructureType type = StructureType::InstanceProperties;
  void *XR_MAY_ALIAS next = nullptr;
...
struct EventDataBuffer {
  ...
  StructureType type = StructureType::EventDataBuffer;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SystemGetInfo {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SystemGetInfo(const FormFactor &formFactor_ = {}) : formFactor{formFactor_} {}
#endif
  ...
  StructureType type = StructureType::SystemGetInfo;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SystemGraphicsProperties {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SystemGraphicsProperties(uint32_t maxSwapchainImageHeight_ = {},
                           uint32_t maxSwapchainImageWidth_ = {},
...
struct SystemTrackingProperties {
  ...
  Bool32 orientationTracking = XR_FALSE;
  Bool32 positionTracking = XR_FALSE;
};
...
struct SystemProperties {
  ...
  StructureType type = StructureType::SystemProperties;
  void *XR_MAY_ALIAS next = nullptr;
  SystemId systemId = {};
  uint32_t vendorId = {};
...
struct SessionCreateInfo {
  ...
  StructureType type = StructureType::SessionCreateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SpaceVelocity {
  ...
  StructureType type = StructureType::SpaceVelocity;
  void *XR_MAY_ALIAS next = nullptr;
...
struct ReferenceSpaceCreateInfo {
  ...
  StructureType type = StructureType::ReferenceSpaceCreateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct ActionSpaceCreateInfo {
  ...
  StructureType type = StructureType::ActionSpaceCreateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  Action action = {};
  Path subactionPath = {};
...
struct SpaceLocation {
  ...
  StructureType type = StructureType::SpaceLocation;
  void *XR_MAY_ALIAS next = nullptr;
...
struct ViewConfigurationProperties {
  ...
  StructureType type = StructureType::ViewConfigurationProperties;
  void *XR_MAY_ALIAS next = nullptr;
  ViewConfigurationType viewConfigurationType = {};
  Bool32 fovMutable = XR_FALSE;
};
...
struct ViewConfigurationView {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  ViewConfigurationView(uint32_t recommendedImageRectWidth_ = {},
                        uint32_t maxImageRectWidth_ = {},
                        uint32_t recommendedImageRectHeight_ = {},
                        uint32_t maxImageRectHeight_ = {},
                        uint32_t recommendedSwapchainSampleCount_ = {},
                        uint32_t maxSwapchainSampleCount_ = {})
  ...
  StructureType type = StructureType::ViewConfigurationView;
  void *XR_MAY_ALIAS next = nullptr;
...
struct SwapchainCreateInfo {
  ...
  SwapchainCreateInfo(const SwapchainCreateFlags &createFlags_ = {},
                      ...
                      int64_t format_ = {}, uint32_t sampleCount_ = {},
                      uint32_t width_ = {}, uint32_t height_ = {},
                      uint32_t faceCount_ = {}, uint32_t arraySize_ = {},
                      uint32_t mipCount_ = {})
  ...
  StructureType type = StructureType::SwapchainCreateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
...
//! @brief Free function accessor for SwapchainImageBaseHeader const reference
//! as a raw XrSwapchainImageBaseHeader const pointer
//! @relates SwapchainImageBaseHeader
OPENXR_HPP_INLINE XrSwapchainImageBaseHeader const *
get(SwapchainImageBaseHeader const &h) {
  return &(h.operator XrSwapchainImageBaseHeader const &());
}

//! @brief Free function accessor for passing SwapchainImageBaseHeader as the
//! address of a raw XrSwapchainImageBaseHeader
//! @relates SwapchainImageBaseHeader
OPENXR_HPP_INLINE XrSwapchainImageBaseHeader *put(SwapchainImageBaseHeader &h) {
  return &(h.operator XrSwapchainImageBaseHeader &());
}
...
struct SwapchainImageAcquireInfo {
  ...
  StructureType type = StructureType::SwapchainImageAcquireInfo;
  const void *XR_MAY_ALIAS next = nullptr;
};
...
struct SwapchainImageWaitInfo {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SwapchainImageWaitInfo(const Duration &timeout_ = {}) : timeout{timeout_} {}
#endif
  ...
  StructureType type = StructureType::SwapchainImageWaitInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  Duration timeout = {};
};
...
struct SwapchainImageReleaseInfo {
  ...
  StructureType type = StructureType::SwapchainImageReleaseInfo;
  const void *XR_MAY_ALIAS next = nullptr;
};
...
struct SessionBeginInfo {
  ...
  StructureType type = StructureType::SessionBeginInfo;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct FrameWaitInfo {
  ...
  StructureType type = StructureType::FrameWaitInfo;
  const void *XR_MAY_ALIAS next = nullptr;
};
...
struct FrameState {
  ...
  StructureType type = StructureType::FrameState;
  void *XR_MAY_ALIAS next = nullptr;
  Time predictedDisplayTime = {};
  Duration predictedDisplayPeriod = {};
  Bool32 shouldRender = XR_FALSE;
};
...
struct FrameBeginInfo {
  ...
  StructureType type = StructureType::FrameBeginInfo;
  const void *XR_MAY_ALIAS next = nullptr;
};
...
//! @brief Free function accessor for CompositionLayerBaseHeader const reference
//! as a raw XrCompositionLayerBaseHeader const pointer
//! @relates CompositionLayerBaseHeader
OPENXR_HPP_INLINE XrCompositionLayerBaseHeader const *
get(CompositionLayerBaseHeader const &h) {
  return &(h.operator XrCompositionLayerBaseHeader const &());
}

//! @brief Free function accessor for passing CompositionLayerBaseHeader as the
//! address of a raw XrCompositionLayerBaseHeader
//! @relates CompositionLayerBaseHeader
OPENXR_HPP_INLINE XrCompositionLayerBaseHeader *
put(CompositionLayerBaseHeader &h) {
  return &(h.operator XrCompositionLayerBaseHeader &());
}
...
struct ViewLocateInfo {
  ...
  StructureType type = StructureType::ViewLocateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  ViewConfigurationType viewConfigurationType = {};
  Time displayTime = {};
  Space space = {};
...
struct ViewState {
  ...
  StructureType type = StructureType::ViewState;
  void *XR_MAY_ALIAS next = nullptr;
...
struct View {
  ...
  StructureType type = StructureType::View;
  void *XR_MAY_ALIAS next = nullptr;
  Posef pose = {};
  Fovf fov = {};
};
...
struct ActionSetCreateInfo {
  ...
  StructureType type = StructureType::ActionSetCreateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct ActionCreateInfo {
  ...
  StructureType type = StructureType::ActionCreateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  char actionName[XR_MAX_ACTION_NAME_SIZE] = {};
  ActionType actionType = {};
  uint32_t countSubactionPaths = {};
  const Path *subactionPaths = nullptr;
...
struct InteractionProfileSuggestedBinding {
  ...
  StructureType type = StructureType::InteractionProfileSuggestedBinding;
  const void *XR_MAY_ALIAS next = nullptr;
  Path interactionProfile = {};
  uint32_t countSuggestedBindings = {};
  const ActionSuggestedBinding *suggestedBindings = nullptr;
};
...
struct SessionActionSetsAttachInfo {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SessionActionSetsAttachInfo(uint32_t countActionSets_ = {},
  ...
  StructureType type = StructureType::SessionActionSetsAttachInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  uint32_t countActionSets = {};
  const ActionSet *actionSets = nullptr;
};
...
struct InteractionProfileState {
  ...
  StructureType type = StructureType::InteractionProfileState;
  void *XR_MAY_ALIAS next = nullptr;
  Path interactionProfile = {};
};
...
struct ActionStateGetInfo {
  ...
  StructureType type = StructureType::ActionStateGetInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  Action action = {};
  Path subactionPath = {};
};
...
struct ActionStateBoolean {
  ...
  StructureType type = StructureType::ActionStateBoolean;
  void *XR_MAY_ALIAS next = nullptr;
  Bool32 currentState = XR_FALSE;
  Bool32 changedSinceLastSync = XR_FALSE;
  Time lastChangeTime = {};
  Bool32 isActive = XR_FALSE;
};
...
struct ActionStateFloat {
  ...
  StructureType type = StructureType::ActionStateFloat;
  void *XR_MAY_ALIAS next = nullptr;
...
struct ActionStateVector2f {
  ...
  StructureType type = StructureType::ActionStateVector2F;
  void *XR_MAY_ALIAS next = nullptr;
...
struct ActionStatePose {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  ActionStatePose(const Bool32 &isActive_ = XR_FALSE) : isActive{isActive_} {}
#endif
  ...
  StructureType type = StructureType::ActionStatePose;
  void *XR_MAY_ALIAS next = nullptr;
  Bool32 isActive = XR_FALSE;
};
...
struct ActionsSyncInfo {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  ActionsSyncInfo(uint32_t countActiveActionSets_ = {},
  ...
  StructureType type = StructureType::ActionsSyncInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  uint32_t countActiveActionSets = {};
  const ActiveActionSet *activeActionSets = nullptr;
};
...
struct BoundSourcesForActionEnumerateInfo {
  ...
  StructureType type = StructureType::BoundSourcesForActionEnumerateInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  Action action = {};
};
...
struct InputSourceLocalizedNameGetInfo {
  ...
  StructureType type = StructureType::InputSourceLocalizedNameGetInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  Path sourcePath = {};
...
struct HapticActionInfo {
  ...
  StructureType type = StructureType::HapticActionInfo;
  const void *XR_MAY_ALIAS next = nullptr;
  Action action = {};
  Path subactionPath = {};
};
...
//! @brief Free function accessor for HapticBaseHeader const reference as a raw
//! XrHapticBaseHeader const pointer
//! @relates HapticBaseHeader
OPENXR_HPP_INLINE XrHapticBaseHeader const *get(HapticBaseHeader const &h) {
  return &(h.operator XrHapticBaseHeader const &());
}

//! @brief Free function accessor for passing HapticBaseHeader as the address of
//! a raw XrHapticBaseHeader
//! @relates HapticBaseHeader
OPENXR_HPP_INLINE XrHapticBaseHeader *put(HapticBaseHeader &h) {
  return &(h.operator XrHapticBaseHeader &());
}
...
struct BaseInStructure {
  ...
  operator XrBaseInStructure &() {
    return *reinterpret_cast<XrBaseInStructure *>(this);
  }

  StructureType type = StructureType::Unknown;
  const struct XrBaseInStructure *next = nullptr;
};
static_assert(sizeof(BaseInStructure) == sizeof(XrBaseInStructure),
              "struct and wrapper have different size!");

//! @brief Free function accessor for BaseInStructure const reference as a raw
//! XrBaseInStructure const pointer
//! @relates BaseInStructure
OPENXR_HPP_INLINE XrBaseInStructure const *get(BaseInStructure const &h) {
  return &(h.operator XrBaseInStructure const &());
}

//! @brief Free function accessor for passing BaseInStructure as the address of
//! a raw XrBaseInStructure
//! @relates BaseInStructure
OPENXR_HPP_INLINE XrBaseInStructure *put(BaseInStructure &h) {
  return &(h.operator XrBaseInStructure &());
}
...
struct BaseOutStructure {
  ...
  operator XrBaseOutStructure &() {
    return *reinterpret_cast<XrBaseOutStructure *>(this);
  }

  StructureType type = StructureType::Unknown;
  struct XrBaseOutStructure *next = nullptr;
};
static_assert(sizeof(BaseOutStructure) == sizeof(XrBaseOutStructure),
              "struct and wrapper have different size!");

//! @brief Free function accessor for BaseOutStructure const reference as a raw
//! XrBaseOutStructure const pointer
//! @relates BaseOutStructure
OPENXR_HPP_INLINE XrBaseOutStructure const *get(BaseOutStructure const &h) {
  return &(h.operator XrBaseOutStructure const &());
}

//! @brief Free function accessor for passing BaseOutStructure as the address of
//! a raw XrBaseOutStructure
//! @relates BaseOutStructure
OPENXR_HPP_INLINE XrBaseOutStructure *put(BaseOutStructure &h) {
  return &(h.operator XrBaseOutStructure &());
}
...
struct Extent2Di {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  Extent2Di(int32_t width_ = {}, int32_t height_ = {})
      : width{width_}, height{height_} {}
#endif
...
struct CompositionLayerProjectionView {
  ...
  StructureType type = StructureType::CompositionLayerProjectionView;
  const void *XR_MAY_ALIAS next = nullptr;
  Posef pose = {};
  Fovf fov = {};
...
struct CompositionLayerProjection {
  ...
  StructureType type = StructureType::CompositionLayerProjection;
  const void *XR_MAY_ALIAS next = nullptr;
  CompositionLayerFlags layerFlags = {};
  Space space = {};
  uint32_t viewCount = {};
  const CompositionLayerProjectionView *views = nullptr;
};
...
struct CompositionLayerQuad {
  ...
  StructureType type = StructureType::CompositionLayerQuad;
  const void *XR_MAY_ALIAS next = nullptr;
  CompositionLayerFlags layerFlags = {};
  Space space = {};
...
//! @brief Free function accessor for EventDataBaseHeader const reference as a
//! raw XrEventDataBaseHeader const pointer
//! @relates EventDataBaseHeader
OPENXR_HPP_INLINE XrEventDataBaseHeader const *
get(EventDataBaseHeader const &h) {
  return &(h.operator XrEventDataBaseHeader const &());
}

//! @brief Free function accessor for passing EventDataBaseHeader as the address
//! of a raw XrEventDataBaseHeader
//! @relates EventDataBaseHeader
OPENXR_HPP_INLINE XrEventDataBaseHeader *put(EventDataBaseHeader &h) {
  return &(h.operator XrEventDataBaseHeader &());
}

struct EventDataEventsLost {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  EventDataEventsLost(uint32_t lostEventCount_ = {})
  ...
  StructureType type = StructureType::EventDataEventsLost;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct EventDataInstanceLossPending {
  ...
  StructureType type = StructureType::EventDataInstanceLossPending;
  const void *XR_MAY_ALIAS next = nullptr;
  Time lossTime = {};
};
...
struct EventDataSessionStateChanged {
  ...
  StructureType type = StructureType::EventDataSessionStateChanged;
  const void *XR_MAY_ALIAS next = nullptr;
  Session session = {};
  SessionState state = {};
  Time time = {};
...
struct EventDataReferenceSpaceChangePending {
  ...
  StructureType type = StructureType::EventDataReferenceSpaceChangePending;
  const void *XR_MAY_ALIAS next = nullptr;
  Session session = {};
  ReferenceSpaceType referenceSpaceType = {};
  Time changeTime = {};
  Bool32 poseValid = XR_FALSE;
...
struct EventDataInteractionProfileChanged {
  ...
  StructureType type = StructureType::EventDataInteractionProfileChanged;
  const void *XR_MAY_ALIAS next = nullptr;
  Session session = {};
};
...
struct HapticVibration {
  ...
  StructureType type = StructureType::HapticVibration;
  const void *XR_MAY_ALIAS next = nullptr;
  Duration duration = {};
...
struct Offset2Df {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  Offset2Df(float x_ = 0.0f, float y_ = 0.0f) : x{x_}, y{y_} {}
#endif
...
struct CompositionLayerCubeKHR {
  ...
  StructureType type = StructureType::CompositionLayerCubeKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  CompositionLayerFlags layerFlags = {};
  Space space = {};
  EyeVisibility eyeVisibility = {};
...
struct InstanceCreateInfoAndroidKHR {
  ...
  StructureType type = StructureType::InstanceCreateInfoAndroidKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  void *XR_MAY_ALIAS applicationVM = nullptr;
  void *XR_MAY_ALIAS applicationActivity = nullptr;
};
...
struct CompositionLayerDepthInfoKHR {
  ...
  StructureType type = StructureType::CompositionLayerDepthInfoKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  SwapchainSubImage subImage = {};
  float minDepth = 0.0f;
  float maxDepth = 0.0f;
...
struct VulkanSwapchainFormatListCreateInfoKHR {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  VulkanSwapchainFormatListCreateInfoKHR(uint32_t viewFormatCount_ = {},
  ...
  StructureType type = StructureType::VulkanSwapchainFormatListCreateInfoKHR;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct CompositionLayerCylinderKHR {
  ...
  StructureType type = StructureType::CompositionLayerCylinderKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  CompositionLayerFlags layerFlags = {};
  Space space = {};
  EyeVisibility eyeVisibility = {};
...
struct CompositionLayerEquirectKHR {
  ...
  StructureType type = StructureType::CompositionLayerEquirectKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  CompositionLayerFlags layerFlags = {};
  Space space = {};
  EyeVisibility eyeVisibility = {};
...
struct GraphicsBindingOpenGLWin32KHR {
  ...
  StructureType type = StructureType::GraphicsBindingOpenglWin32KHR;
  const void *XR_MAY_ALIAS next = nullptr;
  HDC hDC = {};
  HGLRC hGLRC = {};
};
...
struct GraphicsBindingOpenGLXlibKHR {
  ...
  StructureType type = StructureType::GraphicsBindingOpenglXlibKHR;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct GraphicsBindingOpenGLXcbKHR {
  ...
  StructureType type = StructureType::GraphicsBindingOpenglXcbKHR;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct GraphicsBindingOpenGLWaylandKHR {
  ...
  StructureType type = StructureType::GraphicsBindingOpenglWaylandKHR;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SwapchainImageOpenGLKHR {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SwapchainImageOpenGLKHR(uint32_t image_ = {}) : image{image_} {}
#endif
  ...
  StructureType type = StructureType::SwapchainImageOpenglKHR;
  void *XR_MAY_ALIAS next = nullptr;
  uint32_t image = {};
};
...
struct GraphicsRequirementsOpenGLKHR {
  ...
  StructureType type = StructureType::GraphicsRequirementsOpenglKHR;
  void *XR_MAY_ALIAS next = nullptr;
...
struct GraphicsBindingOpenGLESAndroidKHR {
  ...
  StructureType type = StructureType::GraphicsBindingOpenglEsAndroidKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  EGLDisplay display = {};
  EGLConfig config = {};
  EGLContext context = {};
...
struct SwapchainImageOpenGLESKHR {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SwapchainImageOpenGLESKHR(uint32_t image_ = {}) : image{image_} {}
#endif
  ...
  StructureType type = StructureType::SwapchainImageOpenglEsKHR;
  void *XR_MAY_ALIAS next = nullptr;
  uint32_t image = {};
};
...
struct GraphicsRequirementsOpenGLESKHR {
  ...
  StructureType type = StructureType::GraphicsRequirementsOpenglEsKHR;
  void *XR_MAY_ALIAS next = nullptr;
  Version minApiVersionSupported = {};
  Version maxApiVersionSupported = {};
};
...
struct GraphicsBindingVulkanKHR {
  ...
  StructureType type = StructureType::GraphicsBindingVulkanKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  VkInstance instance = {};
...
struct SwapchainImageVulkanKHR {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SwapchainImageVulkanKHR(VkImage image_ = {}) : image{image_} {}
#endif
  ...
  StructureType type = StructureType::SwapchainImageVulkanKHR;
  void *XR_MAY_ALIAS next = nullptr;
  VkImage image = {};
};
...
struct GraphicsRequirementsVulkanKHR {
  ...
  StructureType type = StructureType::GraphicsRequirementsVulkanKHR;
  void *XR_MAY_ALIAS next = nullptr;
  Version minApiVersionSupported = {};
  Version maxApiVersionSupported = {};
};
...
struct GraphicsBindingD3D11KHR {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  GraphicsBindingD3D11KHR(ID3D11Device *device_ = nullptr) : device{device_} {}
#endif
  ...
  StructureType type = StructureType::GraphicsBindingD3D11KHR;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SwapchainImageD3D11KHR {
  ...
  StructureType type = StructureType::SwapchainImageD3D11KHR;
  void *XR_MAY_ALIAS next = nullptr;
...
struct GraphicsRequirementsD3D11KHR {
  ...
  StructureType type = StructureType::GraphicsRequirementsD3D11KHR;
  void *XR_MAY_ALIAS next = nullptr;
  LUID adapterLuid = {};
...
struct GraphicsBindingD3D12KHR {
  ...
  StructureType type = StructureType::GraphicsBindingD3D12KHR;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SwapchainImageD3D12KHR {
  ...
  StructureType type = StructureType::SwapchainImageD3D12KHR;
  void *XR_MAY_ALIAS next = nullptr;
...
struct GraphicsRequirementsD3D12KHR {
  ...
  StructureType type = StructureType::GraphicsRequirementsD3D12KHR;
  void *XR_MAY_ALIAS next = nullptr;
  LUID adapterLuid = {};
  D3D_FEATURE_LEVEL minFeatureLevel = {};
};
...
struct VisibilityMaskKHR {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  VisibilityMaskKHR(uint32_t vertexCapacityInput_ = {},
                    uint32_t vertexCountOutput_ = {},
                    Vector2f *vertices_ = nullptr,
                    uint32_t indexCapacityInput_ = {},
                    uint32_t indexCountOutput_ = {},
  ...
  StructureType type = StructureType::VisibilityMaskKHR;
  void *XR_MAY_ALIAS next = nullptr;
  uint32_t vertexCapacityInput = {};
  uint32_t vertexCountOutput = {};
  Vector2f *vertices = nullptr;
...
struct EventDataVisibilityMaskChangedKHR {
  ...
  StructureType type = StructureType::EventDataVisibilityMaskChangedKHR;
  const void *XR_MAY_ALIAS next = nullptr;
  Session session = {};
  ViewConfigurationType viewConfigurationType = {};
  uint32_t viewIndex = {};
...
struct EventDataPerfSettingsEXT {
  ...
  StructureType type = StructureType::EventDataPerfSettingsEXT;
  const void *XR_MAY_ALIAS next = nullptr;
  PerfSettingsDomainEXT domain = {};
...
struct DebugUtilsObjectNameInfoEXT {
  ...
  StructureType type = StructureType::DebugUtilsObjectNameInfoEXT;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct DebugUtilsLabelEXT {
  ...
  StructureType type = StructureType::DebugUtilsLabelEXT;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct DebugUtilsMessengerCallbackDataEXT {
  ...
  DebugUtilsMessengerCallbackDataEXT(
      ...
      const char *message_ = nullptr, uint32_t objectCount_ = {},
  ...
  StructureType type = StructureType::DebugUtilsMessengerCallbackDataEXT;
  const void *XR_MAY_ALIAS next = nullptr;
  const char *messageId = nullptr;
  const char *functionName = nullptr;
  const char *message = nullptr;
  uint32_t objectCount = {};
  DebugUtilsObjectNameInfoEXT *objects = nullptr;
  uint32_t sessionLabelCount = {};
  DebugUtilsLabelEXT *sessionLabels = nullptr;
};
...
struct SystemEyeGazeInteractionPropertiesEXT {
  ...
  StructureType type = StructureType::SystemEyeGazeInteractionPropertiesEXT;
  void *XR_MAY_ALIAS next = nullptr;
  Bool32 supportsEyeGazeInteraction = XR_FALSE;
};
...
struct EyeGazeSampleTimeEXT {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  EyeGazeSampleTimeEXT(const Time &time_ = {}) : time{time_} {}
#endif
  ...
  StructureType type = StructureType::EyeGazeSampleTimeEXT;
  void *XR_MAY_ALIAS next = nullptr;
  Time time = {};
};
...
struct SessionCreateInfoOverlayEXTX {
  ...
  SessionCreateInfoOverlayEXTX(
      ...
      uint32_t sessionLayersPlacement_ = {})
  ...
  StructureType type = StructureType::SessionCreateInfoOverlayEXTX;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct EventDataMainSessionVisibilityChangedEXTX {
  ...
  StructureType type = StructureType::EventDataMainSessionVisibilityChangedEXTX;
  const void *XR_MAY_ALIAS next = nullptr;
  Bool32 visible = XR_FALSE;
...
struct SpatialAnchorCreateInfoMSFT {
  ...
  StructureType type = StructureType::SpatialAnchorCreateInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  Space space = {};
  Posef pose = {};
  Time time = {};
...
struct SpatialAnchorSpaceCreateInfoMSFT {
  ...
  StructureType type = StructureType::SpatialAnchorSpaceCreateInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  SpatialAnchorMSFT anchor = {};
...
struct ViewConfigurationDepthRangeEXT {
  ...
  StructureType type = StructureType::ViewConfigurationDepthRangeEXT;
  void *XR_MAY_ALIAS next = nullptr;
  float recommendedNearZ = 0.0f;
  float minNearZ = 0.0f;
  float recommendedFarZ = 0.0f;
  float maxFarZ = 0.0f;
};
...
struct GraphicsBindingEGLMNDX {
  ...
  StructureType type = StructureType::GraphicsBindingEglMNDX;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SpatialGraphNodeSpaceCreateInfoMSFT {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  SpatialGraphNodeSpaceCreateInfoMSFT(
      const SpatialGraphNodeTypeMSFT &nodeType_ = {}, uint8_t nodeId[16] _ = {},
      const Posef &pose_ = {})
  ...
  StructureType type = StructureType::SpatialGraphNodeSpaceCreateInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct SystemHandTrackingPropertiesEXT {
  ...
  StructureType type = StructureType::SystemHandTrackingPropertiesEXT;
  void *XR_MAY_ALIAS next = nullptr;
  Bool32 supportsHandTracking = XR_FALSE;
};
...
struct HandTrackerCreateInfoEXT {
  ...
  StructureType type = StructureType::HandTrackerCreateInfoEXT;
  const void *XR_MAY_ALIAS next = nullptr;
  HandEXT hand = {};
...
struct HandJointsLocateInfoEXT {
  ...
  StructureType type = StructureType::HandJointsLocateInfoEXT;
  const void *XR_MAY_ALIAS next = nullptr;
  Space baseSpace = {};
  Time time = {};
};
...
struct HandJointLocationsEXT {
  ...
  StructureType type = StructureType::HandJointLocationsEXT;
  void *XR_MAY_ALIAS next = nullptr;
  Bool32 isActive = XR_FALSE;
  uint32_t jointCount = {};
  HandJointLocationEXT *jointLocations = nullptr;
};
...
struct HandJointVelocitiesEXT {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  HandJointVelocitiesEXT(uint32_t jointCount_ = {},
  ...
  StructureType type = StructureType::HandJointVelocitiesEXT;
  void *XR_MAY_ALIAS next = nullptr;
  uint32_t jointCount = {};
  HandJointVelocityEXT *jointVelocities = nullptr;
};
...
struct SystemHandTrackingMeshPropertiesMSFT {
  ...
  SystemHandTrackingMeshPropertiesMSFT(
      ...
      uint32_t maxHandMeshIndexCount_ = {},
      uint32_t maxHandMeshVertexCount_ = {})
  ...
  StructureType type = StructureType::SystemHandTrackingMeshPropertiesMSFT;
  void *XR_MAY_ALIAS next = nullptr;
  Bool32 supportsHandTrackingMesh = XR_FALSE;
...
struct HandMeshSpaceCreateInfoMSFT {
  ...
  StructureType type = StructureType::HandMeshSpaceCreateInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
...
struct HandMeshUpdateInfoMSFT {
  ...
  StructureType type = StructureType::HandMeshUpdateInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  Time time = {};
  HandPoseTypeMSFT handPoseType = {};
};
...
struct HandMeshIndexBufferMSFT {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  HandMeshIndexBufferMSFT(uint32_t indexBufferKey_ = {},
                          uint32_t indexCapacityInput_ = {},
                          uint32_t indexCountOutput_ = {},
                          uint32_t *indices_ = nullptr)
...
struct HandMeshVertexBufferMSFT {
  ...
  uint32_t vertexCapacityInput = {};
  uint32_t vertexCountOutput = {};
  HandMeshVertexMSFT *vertices = nullptr;
};
...
struct HandMeshMSFT {
  ...
  StructureType type = StructureType::HandMeshMSFT;
  void *XR_MAY_ALIAS next = nullptr;
  Bool32 isActive = XR_FALSE;
  Bool32 indexBufferChanged = XR_FALSE;
  Bool32 vertexBufferChanged = XR_FALSE;
...
struct HandPoseTypeInfoMSFT {
  ...
  StructureType type = StructureType::HandPoseTypeInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  HandPoseTypeMSFT handPoseType = {};
};
...
struct SecondaryViewConfigurationSessionBeginInfoMSFT {
  ...
  StructureType type =
      StructureType::SecondaryViewConfigurationSessionBeginInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  uint32_t viewConfigurationCount = {};
  const ViewConfigurationType *enabledViewConfigurationTypes = nullptr;
};
...
struct SecondaryViewConfigurationStateMSFT {
  ...
  StructureType type = StructureType::SecondaryViewConfigurationStateMSFT;
  void *XR_MAY_ALIAS next = nullptr;
  ViewConfigurationType viewConfigurationType = {};
  Bool32 active = XR_FALSE;
};
...
struct SecondaryViewConfigurationFrameStateMSFT {
  ...
  StructureType type = StructureType::SecondaryViewConfigurationFrameStateMSFT;
  void *XR_MAY_ALIAS next = nullptr;
  uint32_t viewConfigurationCount = {};
  SecondaryViewConfigurationStateMSFT *viewConfigurationStates = nullptr;
};
...
struct SecondaryViewConfigurationLayerInfoMSFT {
  ...
  StructureType type = StructureType::SecondaryViewConfigurationLayerInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  ViewConfigurationType viewConfigurationType = {};
  EnvironmentBlendMode environmentBlendMode = {};
  uint32_t layerCount = {};
...
struct SecondaryViewConfigurationFrameEndInfoMSFT {
  ...
  StructureType type =
      StructureType::SecondaryViewConfigurationFrameEndInfoMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  uint32_t viewConfigurationCount = {};
...
struct ViewConfigurationViewFovEPIC {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  ViewConfigurationViewFovEPIC(const Fovf &recommendedFov_ = {},
                               const Fovf &maxMutableFov_ = {})
      : recommendedFov{recommendedFov_}, maxMutableFov{maxMutableFov_} {}
#endif
  ...
  StructureType type = StructureType::ViewConfigurationViewFovEPIC;
  const void *XR_MAY_ALIAS next = nullptr;
  Fovf recommendedFov = {};
  Fovf maxMutableFov = {};
};
...
struct HolographicWindowAttachmentMSFT {
#ifndef OPENXR_HPP_NO_CONSTRUCTOR
  HolographicWindowAttachmentMSFT(IUnknown *holographicSpace_ = nullptr,
                                  IUnknown *coreWindow_ = nullptr)
      : holographicSpace{holographicSpace_}, coreWindow{coreWindow_} {}
#endif
  ...
  StructureType type = StructureType::HolographicWindowAttachmentMSFT;
  const void *XR_MAY_ALIAS next = nullptr;
  IUnknown *holographicSpace = nullptr;
  IUnknown *coreWindow = nullptr;
};
static_assert(sizeof(HolographicWindowAttachmentMSFT) ==
                  sizeof(XrHolographicWindowAttachmentMSFT),
              "struct and wrapper have different size!");

//! @brief Free function accessor for HolographicWindowAttachmentMSFT const
//! reference as a raw XrHolographicWindowAttachmentMSFT const pointer
//! @relates HolographicWindowAttachmentMSFT
OPENXR_HPP_INLINE XrHolographicWindowAttachmentMSFT const *
get(HolographicWindowAttachmentMSFT const &h) {
  return &(h.operator XrHolographicWindowAttachmentMSFT const &());
}

//! @brief Free function accessor for passing HolographicWindowAttachmentMSFT as
//! the address of a raw XrHolographicWindowAttachmentMSFT
//! @relates HolographicWindowAttachmentMSFT
OPENXR_HPP_INLINE XrHolographicWindowAttachmentMSFT *
put(HolographicWindowAttachmentMSFT &h) {
  return &(h.operator XrHolographicWindowAttachmentMSFT &());
}
...
struct InteractionProfileAnalogThresholdVALVE {
  ...
  InteractionProfileAnalogThresholdVALVE(
      ...
      float onThreshold_ = 0.0f, float offThreshold_ = 0.0f,
      const HapticBaseHeader *onHaptic_ = nullptr,
      const HapticBaseHeader *offHaptic_ = nullptr)
      : action{action_}, binding{binding_}, onThreshold{onThreshold_},
        offThreshold{offThreshold_}, onHaptic{onHaptic_}, offHaptic{
                                                              offHaptic_} {}
#endif
  operator const XrInteractionProfileAnalogThresholdVALVE &() const {
    return *reinterpret_cast<const XrInteractionProfileAnalogThresholdVALVE *>(
        this);
  }
  ...
  StructureType type = StructureType::InteractionProfileAnalogThresholdVALVE;
  const void *XR_MAY_ALIAS next = nullptr;
  Action action = {};
  Path binding = {};
  float onThreshold = 0.0f;
  float offThreshold = 0.0f;
  const HapticBaseHeader *onHaptic = nullptr;
  const HapticBaseHeader *offHaptic = nullptr;
};
static_assert(sizeof(InteractionProfileAnalogThresholdVALVE) ==
                  sizeof(XrInteractionProfileAnalogThresholdVALVE),
              "struct and wrapper have different size!");

//! @brief Free function accessor for InteractionProfileAnalogThresholdVALVE
//! const reference as a raw XrInteractionProfileAnalogThresholdVALVE const
//! pointer
//! @relates InteractionProfileAnalogThresholdVALVE
OPENXR_HPP_INLINE XrInteractionProfileAnalogThresholdVALVE const *
get(InteractionProfileAnalogThresholdVALVE const &h) {
...
//! @relates InteractionProfileAnalogThresholdVALVE
OPENXR_HPP_INLINE XrInteractionProfileAnalogThresholdVALVE *
put(InteractionProfileAnalogThresholdVALVE &h) {
  return &(h.operator XrInteractionProfileAnalogThresholdVALVE &());
}
 ...
 * early-populate it using the populateFully() method, providing an Instance.
 *
...
public:
  ...
  explicit DispatchLoaderDynamic(
      ...
      PFN_xrGetInstanceProcAddr getInstanceProcAddr = nullptr) noexcept
      : m_instance(instance),
  ...
  void populateBase(
    ...
    OPENXR_HPP_ASSERT(pfnGetInstanceProcAddr);
    getInstanceProcAddr(XR_NULL_HANDLE, "xrCreateInstance", &pfnCreateInstance);
    getInstanceProcAddr(XR_NULL_HANDLE, "xrEnumerateApiLayerProperties",
                        &pfnEnumerateApiLayerProperties);
    getInstanceProcAddr(XR_NULL_HANDLE,
  ...
  void populateFully(
    ...
    populate_("xrEnumerateInstanceExtensionProperties",
              pfnEnumerateInstanceExtensionProperties);
    ...
    populate_("xrEnumerateEnvironmentBlendModes",
    ...
    populate_("xrGetViewConfigurationProperties",
              pfnGetViewConfigurationProperties);
    populate_("xrEnumerateViewConfigurationViews",
    ...
    populate_("xrEnumerateBoundSourcesForAction",
    ...
    populate_("xrSetAndroidApplicationThreadKHR",
              pfnSetAndroidApplicationThreadKHR);
    populate_("xrCreateSwapchainAndroidSurfaceKHR",
              pfnCreateSwapchainAndroidSurfaceKHR);
    populate_("xrGetOpenGLGraphicsRequirementsKHR",
              pfnGetOpenGLGraphicsRequirementsKHR);
    populate_("xrGetOpenGLESGraphicsRequirementsKHR",
              pfnGetOpenGLESGraphicsRequirementsKHR);
    populate_("xrGetVulkanInstanceExtensionsKHR",
              pfnGetVulkanInstanceExtensionsKHR);
    populate_("xrGetVulkanDeviceExtensionsKHR",
              pfnGetVulkanDeviceExtensionsKHR);
    populate_("xrGetVulkanGraphicsDeviceKHR", pfnGetVulkanGraphicsDeviceKHR);
    populate_("xrGetVulkanGraphicsRequirementsKHR",
              pfnGetVulkanGraphicsRequirementsKHR);
    populate_("xrGetD3D11GraphicsRequirementsKHR",
              pfnGetD3D11GraphicsRequirementsKHR);
    populate_("xrGetD3D12GraphicsRequirementsKHR",
...
private:
  ...
  //! nullptr.
  XrResult populate_(const char *function_name,
                     PFN_xrVoidFunction &pfn) noexcept {
    if (pfn == nullptr) {
      return reinterpret_cast<PFN_xrGetInstanceProcAddr>(
...
Instance::createSession(const SessionCreateInfo &createInfo, Dispatch d) const {
  Session handle;
  Result result = static_cast<Result>(d.xrCreateSession(
...
ActionSet::createAction(const ActionCreateInfo &createInfo, Dispatch d) const {
  Action handle;
  Result result = static_cast<Result>(d.xrCreateAction(
      this->get(), OPENXR_HPP_NAMESPACE::get(createInfo), handle.put()));
  return impl::createResultValue(
...
Session::getActionStateVector2f(const ActionStateGetInfo &getInfo,
                                ActionStateVector2f &state, Dispatch d) const {
...
Instance::getVulkanGraphicsDeviceKHR(const SystemId &systemId,
                                     VkInstance vkInstance, Dispatch d) const {
