...
Scene make_scene()
{
    ...
    /*scene.objects.emplace_back(Object{
                .name = std::string("sphere_") + std::to_string(0),
                .position = glm::vec3(0.0f, 1.5f, 0.0f), .rotation = glm::quat(1.0f, 0.0f, 0.0f, 0.0f), .scale = 0.5f,
                .group_id = sphere_id });*/
    /*scene.objects.emplace_back(Object{
                .name = std::string("cube_") + std::to_string(0),
                .position = glm::vec3(0.0f, 3.0f, -2.0f), .rotation = glm::quat(1.0f, 0.0f, 0.0f, 0.0f), .scale = 1.0f,
                .group_id = cube_id });*/
