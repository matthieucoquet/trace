    ...
    m_device(context.device)
{
    ...
    std::array shader_stages{
        vk::PipelineShaderStageCreateInfo()
            ...
            .setModule(shader_module_from_file("shaders/raygen.spv"))
            .setPName("main"),
        vk::PipelineShaderStageCreateInfo()
            .setStage(vk::ShaderStageFlagBits::eMissKHR)
            .setModule(shader_module_from_file("shaders/miss.spv"))
            .setPName("main"),
        // Sphere
        vk::PipelineShaderStageCreateInfo()
            .setStage(vk::ShaderStageFlagBits::eIntersectionKHR)
            .setModule(shader_module_from_file("shaders/sphere_int.spv"))
            .setPName("main"),
        vk::PipelineShaderStageCreateInfo()
            .setStage(vk::ShaderStageFlagBits::eClosestHitKHR)
            .setModule(shader_module_from_file("shaders/sphere_chit.spv"))
            .setPName("main"),
        // Cube
        vk::PipelineShaderStageCreateInfo()
            .setStage(vk::ShaderStageFlagBits::eIntersectionKHR)
            .setModule(shader_module_from_file("shaders/cube_int.spv"))
            .setPName("main"),
        vk::PipelineShaderStageCreateInfo()
            .setStage(vk::ShaderStageFlagBits::eClosestHitKHR)
            .setModule(shader_module_from_file("shaders/cube_chit.spv"))
            .setPName("main"),
    };
...
vk::ShaderModule Raytracing_pipeline::shader_module_from_file(std::filesystem::path path) const
{
